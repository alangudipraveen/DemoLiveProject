...
Feature: Login functinality scenarios
	...
	Scenario: Verify whether the User is able to login with valid credentials
	  ...
	  When I login to the application using Username "naveen1234@gmail.com" and Password "naveenk"
   ...
   @Login @Two
    Scenario: Verify that the User is not able to login with invalid credentials
      Given I launch the application
	    And I naviage to Account Login page
	    When I login to the application using Username "naveen1234@gmail.com" and Password "naveenkk"
    ...
    Given I launch the application
	  And I naviage to Account Login page
	  When I reset the forgotten password for "naveen1234@gmail.com"
